...
export const KofiFooter = () => {
  return <div className="w-full flex justify-center py-6">
      <a href="https://ko-fi.com/mezohehe" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
